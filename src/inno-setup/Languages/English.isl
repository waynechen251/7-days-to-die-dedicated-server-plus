...
AddonHostProgramNotFound=%1 could not be located in the folder you selected.
...
GameServerTelnetPort=Game Server Telnet Port
GameServerTelnetPassword=Game Server Telnet Password
WebPortEmpty=Web Port cannot be empty.
GameServerPortInvalid=Game Server Port is invalid.
GameServerPortEmpty=Game Server Port cannot be empty.
GameServerTelnetPortInvalid=Game Server Telnet Port is invalid.
GameServerTelnetPortEmpty=Game Server Telnet Port cannot be empty.
GameServerTelnetPasswordEmpty=Game Server Telnet Password cannot be empty.
