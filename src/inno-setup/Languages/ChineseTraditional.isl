...
WebPort=管理後臺通訊埠
GameServerPort=遊戲伺服器通訊埠
GameServerTelnetPort=遊戲伺服器 Telnet 通訊埠
GameServerTelnetPassword=遊戲伺服器 Telnet 密碼
WebPortEmpty=管理後臺通訊埠不能為空。
GameServerPortInvalid=遊戲伺服器通訊埠無效。
GameServerPortEmpty=遊戲伺服器通訊埠不能為空。
GameServerTelnetPortInvalid=遊戲伺服器 Telnet 通訊埠無效。
GameServerTelnetPortEmpty=遊戲伺服器 Telnet 通訊埠不能為空。
GameServerTelnetPasswordEmpty=遊戲伺服器 Telnet 密碼不能為空。
portIsUsed=通訊埠已被占用。
IpEmpty=IP 地址不能為空。
IpInvalid=IP 地址無效。
PortEmpty=通訊埠不能為空。
