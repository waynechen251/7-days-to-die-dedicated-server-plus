...
WebPort=Web 端口不能为空。
GameServerPort=游戏服务器端口
GameServerTelnetPort=游戏服务器 Telnet 端口
GameServerTelnetPassword=游戏服务器 Telnet 密码
WebPortEmpty=Web 端口不能为空。
GameServerPortInvalid=游戏服务器端口无效。
GameServerPortEmpty=游戏服务器端口不能为空。
GameServerTelnetPortInvalid=游戏服务器 Telnet 端口无效。
GameServerTelnetPortEmpty=游戏服务器 Telnet 端口不能为空。
GameServerTelnetPasswordEmpty=游戏服务器 Telnet 密码不能为空。
portIsUsed=端口已被占用。
IpEmpty=IP 地址不能为空。
IpInvalid=IP 地址无效。
PortEmpty=端口不能为空。
